...
![1550481243758](20190219165608.png)

消费者启动

celery -A app.tests worker -l info -P eventlet



当时celery 3.2版本出现问题后用4.2.1解决了问题



6.

![1550481243758](20190219170800.png)

7.成功

![1550481243758](20190220084355.png)

```
[2019-02-20 08:48:53,561: INFO/MainProcess] Task app.tests.send_by_luosimao[b043dfd3-dad8-49d8-8fc7-43bab8da88b9] succeeded in 0.8889999999955762s: b'{"error":0,"deposit":"5"}'
```
...
def graph(request):
    ...
    return HttpResponse(code_bytes, content_type
...
![1550481243758](20190220120223.png)
